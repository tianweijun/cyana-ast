...
StringTreeGraphicsItem::StringTreeGraphicsItem(StringTree *stringTree)
...
void BoxTreeContext::build(StringTree *stringTree) {
...
Box *BoxTreeContext::initBoxTree(StringTree *strTree, Box *parent,
