...
#ifndef CYANA_AST_RUNTIME__LOGGER_H_
#define CYANA_AST_RUNTIME__LOGGER_H_
...
class Logger {
 public:
  ...
  void log(Level level, const char *file, int line, const char *format, ...) const;
...
#endif//CYANA_AST_RUNTIME__LOGGER_H_